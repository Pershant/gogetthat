...
module.exports = {
    listing: async (req, res) => {
        try {
            ...
            const data = listing.map((taxCategory, index) => {
                ...
                const viewButton = `<a href="/admin/setting/taxCategory/view/${taxCategory.id}" class="btn btn-outline-info" >View</a>`;
                const editButton = `<a href="/admin/setting/taxCategory/edit/${taxCategory.id}" class="btn btn-outline-warning" >Edit</a>`;
            ...
            return res.render('admin/setting/taxCategory/listing', { headerColumns, data });
        } catch (err) {
    ...
    add: async (req, res) => {
        try {
            ...
            return res.render('admin/setting/taxCategory/addEdit', { taxCategory: undefined });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    edit: async (req, res) => {
        try {
            ...
            return res.render('admin/setting/taxCategory/addEdit', { taxCategory });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    view: async (req, res) => {
        try {
            ...
            return res.render('admin/setting/taxCategory/view', { taxCategory });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    addUpdateTaxCategory: async (req, res) => {
        try {
            ...
            res.redirect('/admin/setting#tax');
        } catch (err) {
            err.code = 200;
            return helper.error(res, err);
        }
