        ...
        try {
            ...
            const data = listing.map((report, index) => {
                return Object.values({
                    ...
                    action: `
                    <a href="/admin/order/listing?currentSubModule=${currentSubModule}&currentSubModuleSidebar=${currentSubModuleSidebar}${from ? `&from=${from}` : ''}${to ? `&to=${to}` : ''}">
        ...
        try {
            ...
            const data = listing.map((order, index) => {
                return Object.values({
                    ...
                    action: `
                    <a href="/admin/order/customerOrders?currentSubModule=${currentSubModule}&currentSubModuleSidebar=${currentSubModuleSidebar}${from ? `&from=${from}` : ''}${to ? `&to=${to}` : ''}&customerId=${order.customerId}">
                        <button type="button" class="btn btn-warning">View</button>
                    </a>`,
                    // date: moment(report.createdAt).format('YYYY-MM-DD'),
                    // action
        ...
        try {
            ...
            const data = listing.map((order, index) => {
                return Object.values({
                    ...
                    action: `
                    <a href="/admin/order/sellerOrders?currentSubModule=${currentSubModule}&currentSubModuleSidebar=${currentSubModuleSidebar}${from ? `&from=${from}` : ''}${to ? `&to=${to}` : ''}&vendorId=${order.vendorId}">
                        <button type="button" class="btn btn-warning">View</button>
                    </a>`,
                    // date: moment(report.createdAt).format('YYYY-MM-DD'),
                    // action
