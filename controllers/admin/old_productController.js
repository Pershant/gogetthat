...
module.exports = {
    ...
    add: async (req, res) => {
        try {
            ...
            return res.render('admin/product/add', { prefixBaseName, taxCategories, categories, subCategories });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    edit: async (req, res) => {
        try {
            ...
            return res.render('admin/product/edit', { prefixBaseName, product, taxCategories, productTags, categories, subCategories, productSpecifications, productSpecificationsHTML });
        } catch (err) {
            return helper.error(res, err);
        }
    },
