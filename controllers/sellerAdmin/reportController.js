...
module.exports = {
        ...
        try {
            ...
            const data = listing.map((report, index) => {
                return Object.values({
                    ...
                    action: `
                    <a href="/sellerAdmin/order/listing?currentSubModule=${currentSubModule}&currentSubModuleSidebar=${currentSubModuleSidebar}${from ? `&from=${from}` : ''}${to ? `&to=${to}` : ''}">
    ...
    userReport: async (req, res) => {
        try {
            ...
            return res.render('sellerAdmin/report/userReport', { headerColumns, data, from, to });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    sellerReport: async (req, res) => {
        try {
            ...
            return res.render('sellerAdmin/report/sellerReport', { headerColumns, data, from, to });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    ...
    totalIncomeReport: async (req, res) => {
        try {
            global.currentModule = 'Report';
            global.currentSubModule = 'Total Income Report';
    ...
    commissionReport: async (req, res) => {
        try {
            ...
            return res.render('sellerAdmin/report/commissionReport', { headerColumns, data, from, to });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    revenueReport: async (req, res) => {
        try {
            ...
            return res.render('sellerAdmin/report/revenueReport', { headerColumns, data, from, to });
        } catch (err) {
            return helper.error(res, err);
        }
    },
    view: async (req, res) => {
        try {
            ...
            return res.render('sellerAdmin/user/view', { user });
        } catch (err) {
            return helper.error(res, err);
        }
    },
